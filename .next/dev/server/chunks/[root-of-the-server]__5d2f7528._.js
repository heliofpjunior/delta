...
"[project]/app/api/consulta/clientes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const { data: customer, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('customers').select('*').or(orFilter).maybeSingle();
        if (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Nenhum dado prévio encontrado para este documento."
        }, {
            status: 404
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d2f7528._.js.map