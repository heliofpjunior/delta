...
function CertificatesPage() {
    ...
    const { data: certificates, error } = useSWR(`/api/certificates?seller=${currentUser.role === 'admin' ? 'admin' : currentUser.name}`, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetcher"]);
    const { data: products } = useSWR("/api/sales", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetcher"]);
    ...
    const handleOrderSubmit = async (data)=>{
        try {
            ...
            if (response.data.success) {
                ...
                mutate(`/api/certificates?seller=${currentUser.role === 'admin' ? 'admin' : currentUser.name}`);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__621380c3._.js.map