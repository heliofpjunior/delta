...
"[project]/app/api/consulta/pedidos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const { data: orders, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('orders').select(`
                id,
                created_at,
                final_price,
        ...
        const mappedOrders = (orders || []).map((order)=>({
                ...
                product_name: order.supplier_product_name || order.products?.name || 'Produto Não Identificado'
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d0d8126._.js.map