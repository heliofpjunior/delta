...
async function PUT(request) {
    ...
    const index = sales.findIndex((p)=>p.id === id);
    if (index === -1) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(sales[index]);
}
async function DELETE(request) {
    const { searchParams } = new URL(request.url);
    const id = searchParams.get('id');
    const index = sales.findIndex((p)=>p.id.toString() === id);
    if (index === -1) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Product not found"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c5567f3._.js.map