...
;
async function GET() {
    const { data: users, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').order('created_at', {
        ascending: false
    });
...
async function PUT(request) {
    ...
    const { data: updatedUser, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update({
        level,
        status
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a92def75._.js.map