...
function CertificatesPage() {
    ...
    const { data: certificates, error } = useSWR(`/api/certificates?seller=${currentUser.role === 'admin' ? 'admin' : currentUser.name}`, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetcher"]);
    const { data: products } = useSWR("/api/sales", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$fetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetcher"]);
...
_s(CertificatesPage, "mFpn1eYhsvji5MdqVNLzfC9S4q0=", true, function() {
    return [
...
//# sourceMappingURL=_5a98be83._.js.map